...
Takamatsu besuchte die Akashi no Miyas English School und später eine chinesische Bildungsschule. Er war ein schwächliches und wehleidiges Kind, weshalb er den Spitznamen _Heulsuse_ hatte.
...
Eines Abends rief jemand: <q>Geh nach Hause!</q>. Doch Takamatsu konnte niemanden sehen und schlief wieder ein.
...
{% productshelf %}
{% product "3924862117", "Takamatsu Toshitsugu: Die Biographie einer Kampfkunstlegende" %}
{% endproductshelf %}
